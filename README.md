...
xccov-proc is an open-source Bitrise step designed to streamline the processing of Xcode coverage reports (xccov). It enables teams to analyze and customize their code coverage data during CI/CD workflows by providing features such as:
